...
export default function MeusAnunciosPage() {
  ...
  const navigation = [
    ...
    { title: "Política de uso", path: "/politica-de-uso" },
...
return (                                 
<li key={idx} className="text-gray-700 hover:text-gray-900">                                      <Link to={item.path} className="block">                                           
{item.title}                                     
</Link>                                   
</li>                               
)                           
...
<Link to="/login" className="block text-gray-700 hover:text-gray-900">Entrar</Link>
<Link to="/cadastro" className="flex items-center justify-center gap-x-1 py-2 px-4 text-white font-medium bg-orange-600 hover:bg-orange-500 active:bg-orange-700 rounded-full md:inline-flex">                          
 Desapegar
