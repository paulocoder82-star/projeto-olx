export default function Anuncios() {
  const team = [
    ...
    },
    {
      ...
      desc: "De R$ 4.999 por R$3.449 com 31% OFF",
    },
    {
      avatar:
        "https://http2.mlstatic.com/D_NQ_NP_2X_678582-MLA99572282914_122025-F.webp",
      name: "Notebook Dell Inspiron I15",
      title: "Notebook Dell Inspiron I15-i1300-a15p Core 3 8gb 512gb W11 Preto",
      desc: "De R$3.699 por R$3.332,92 com 9% OFF no Pix ou R$3.436,00 em 10x R$343,60 sem juros",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="max-w-xl">
          ...
          <p className="text-gray-600 mt-3">
            Aproveite as promoções dos notebooks mais vendidos e acessados com
            as melhores configurações para trabalho diário.
          </p>
        </div>
        <div className="mt-12">
